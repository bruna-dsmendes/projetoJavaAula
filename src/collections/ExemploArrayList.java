...
public class ExemploArrayList {
	...
	public static void main(String[] args) {
		...
		// Cria a Collection ArrayList, do tipo Double, chamada notas
			...
			/**
			 * Mostra a posição (indice) de uma determinada nota. 				 * Caso existam 2 notas iguais será exibida a posição da primeira nota encontrada.
			 */
			...
			// Mostra a nota inserida em uma determinada posição (indice)				System.out.println("\nNa posição 1 da lista, a nota é: " + notas.get(1));
